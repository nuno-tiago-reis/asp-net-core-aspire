...
/// <summary>
/// Implements the interface for the author created event handler.
/// </summary>
///
/// <seealso cref="EventHandler{T}" />
public sealed class AuthorCreatedEventHandler : EventHandler<AuthorCreatedEvent>
{
	#region [Properties]
	/// <summary>
	/// The cache.
	...
	#region [Constructors]
	/// <summary>
	/// Initializes a new instance of the <see cref="AuthorCreatedEventHandler"/> class.
	/// </summary>
	///
	/// <param name="cache">The cache.</param>
	/// <param name="logger">The logger.</param>
	public AuthorCreatedEventHandler(ICache cache, ILogger<AuthorCreatedEventHandler> logger) : base(logger)
	{
		this.Cache = cache;
	}
	#endregion
