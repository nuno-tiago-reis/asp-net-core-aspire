	...
	where TEntityOrderDirection : struct, Enum
{
	...
	/// <summary>
	/// Deletes the entity matching the given entityId.
	/// </summary>
	///
	...
	/// <summary>
	/// Gets the entity matching the given entityId.
	/// </summary>
	///
	/// <param name="entityId">The entity identifier.</param>
	/// <param name="cancellationToken">The cancellation token.</param>
	...
	public virtual async Task<IPage<TEntity>> GetAllAsync(TEntityFilter entityFilter, CancellationToken cancellationToken = default)
	{
		...
		var entities = await PageFactory.CreateAsync
		(
			// entities
			entityQuery,
			entityCountQuery,
	...
	/// <summary>
	/// Checks if a entity matching the given entityId exists.
	/// </summary>
	///
	/// <param name="entityId">The entity identifier.</param>
	/// <param name="cancellationToken">The cancellation token.</param>
	...
	protected abstract IQueryable<TEntity> FilterQueryable(IQueryable<TEntity> queryable, TEntityFilter filter);
	#endregion
	...
	/// <summary>
	/// Tries to get an entity matching the given entityId if it exists.
	/// </summary>
	///
	/// <param name="entityId">The entity identifier.</param>
	/// <param name="cancellationToken">The cancellation token.</param>
